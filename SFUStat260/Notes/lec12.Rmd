...
```{r}
modes <- vector("list",length = ncol(nycflights13::flights)) #class can  have multiple values
for(i in seq_along(nycflights13::flights)){
  modes[[i]] <- mode(nycflights13::flights[[i]])
}
modes
```
...
tibble.
```{r}
my_map_chr(nycflights13::flights,mode)
map(nycflights13::flights,summary)
```
