...
```{r}
youthUI <- gather(youthUI,year,`Unemployment Rate`,`2010`:`2014`,convert=TRUE)
...
```{r}
ggplot(youthUI,aes(x=`year`,y=`Unemployment Rate`,group=`Country Name`))+geom_line(alpha=0.5)
```
